...
import { SukaarLogo } from "@/components/brand/sukaar-logo";
    ...
    <footer className="border-t border-black/5 bg-white">
      <div className="container-poem py-14 md:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_.8fr_.8fr_1fr]">
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-poem-muted">
              Sukaar Welfare Organization is a Sindh-based non-profit working
              with communities across education, health, livelihoods, rights,
        ...
        <div className="mt-10 border-t border-black/5 pt-6 text-sm text-poem-muted">
          <p>© {new Date().getFullYear()} Sukaar Welfare Organization. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
