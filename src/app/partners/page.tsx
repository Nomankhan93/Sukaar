...
export const metadata: Metadata = {
  title: "Partners",
  description: "Partners, donors and institutions working with Sukaar Welfare Organization.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Sukaar works with institutions, donors, networks and communities that share a commitment to inclusive and sustainable development."
        />

        <section className="section-space bg-white">
          <div className="container-poem">
            <SectionHeading eyebrow="Our partners" title="Organizations working alongside Sukaar." />
