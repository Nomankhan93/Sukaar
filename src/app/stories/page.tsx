...
export const metadata: Metadata = {
  title: "Stories",
  description:
    "Community and success stories from Sukaar Welfare Organization projects and programs.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Read community and beneficiary stories that show the human outcomes behind Sukaar's programs and projects."
        />
