...
export const metadata: Metadata = {
  title: "Careers",
  description: "Current career opportunities at Sukaar Welfare Organization.",
};
...
export default async function CareersPage() {
  ...
  return (
    <>
      <SiteHeader />
      <main>
        <PageHero eyebrow="Careers" title="Work with purpose." description="Explore current employment and professional opportunities with Sukaar." />
