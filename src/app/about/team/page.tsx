...
export const metadata: Metadata = {
  title: "Team & Board",
  description: "Meet the team, board and advisors of Sukaar Welfare Organization.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Meet the people responsible for Sukaar's governance, strategy and program delivery."
        />
