...
export const metadata: Metadata = {
  title: "Resources",
  description:
    "Reports, policies, publications, research and accountability resources from Sukaar Welfare Organization.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Explore Sukaar reports, policies, publications, research and case studies."
        />
        ...
        <section className="section-space bg-white">
          <div className="container-poem">
            <SectionHeading
              ...
              description="Published documents are managed directly by Sukaar through the secure administration workspace."
            />
