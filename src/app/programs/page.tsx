...
export const metadata: Metadata = {
  title: "Programs",
  description:
    "Explore Sukaar Welfare Organization's program areas across education, livelihoods, community empowerment and resilience.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Sukaar organizes its work around program areas that respond to community priorities while strengthening long-term opportunity, participation and resilience."
        />
