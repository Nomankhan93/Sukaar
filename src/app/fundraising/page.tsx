...
export const metadata: Metadata = {
  title: "Fundraising",
  description: "Support published Sukaar fundraising campaigns and community-led projects.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Explore verified Sukaar fundraising campaigns, funding targets and progress. Online payment processing is not enabled in this phase; use the verified giving instructions on each campaign."
        />
