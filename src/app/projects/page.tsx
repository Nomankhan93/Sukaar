...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Explore Sukaar Welfare Organization projects and community development initiatives.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Explore Sukaar projects, community priorities, responses, outcomes and SDG alignment."
        />
        ...
        <section className="section-space bg-white">
          <div className="container-poem">
            <SectionHeading
              ...
              description="Published projects are now managed from Sukaar's secure administration workspace."
            />
