        ...
        <section className="border-b border-black/5 bg-white">
          <div className="container-poem py-7">
            {impact.hasPublishedMetrics ? (
              ...
              <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ["Since 2014", "Community development experience"],
                  ["Umerkot, Sindh", "Organizational base"],
                  ["Multi-sector", "Education, health, rights and livelihoods"],
                  ["Community-led", "Mobilization, advocacy and service delivery"],
                ].map(([value, label]) => (
                  <div key={value}>
                    <p className="text-2xl font-black tracking-[-0.04em] text-poem-950">
                      {value}
                    </p>
                    <p className="mt-1 text-xs font-bold text-poem-muted">
                      {label}
            ...
            <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
              <div>
                ...
                <h2 className="mt-4 text-5xl font-extrabold tracking-[-0.055em] text-poem-950">
                  Programs rooted in community priorities.
                </h2>
              </div>
              <p className="max-w-2xl text-base leading-8 text-poem-muted">
                Sukaar combines service delivery, community mobilization, advocacy and
                field implementation across education, health, livelihoods, human
                rights, youth and women empowerment, and resilience.
              </p>
            </div>
              ...
              {content.projects.map((project) => (
                ...
                >
                  {project.coverUrl ? (
                    ...
                    <div className="aspect-[16/10] bg-gradient-to-br from-[#fff7a8] to-[#d6bd4d]" />
                  )}
