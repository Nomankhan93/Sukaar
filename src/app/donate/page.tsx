...
export const metadata: Metadata = {
  title: "Donate",
  description:
    "Support Sukaar Welfare Organization and community-centered development initiatives.",
};
      ...
      <main>
        ...
        <section className="section-space bg-white">
          <div className="container-poem grid gap-10 lg:grid-cols-[1fr_.8fr]">
            <div>
              <SectionHeading
                eyebrow="Why support Sukaar"
                title="Invest in opportunity, participation and resilience."
                description="Support can help Sukaar strengthen community programs, expand access to skills and learning, and improve institutional capacity for sustainable local development."
              />
            ...
            <aside className="rounded-[32px] bg-poem-950 p-7 text-white md:p-9">
              ...
              <h2 className="mt-3 text-3xl font-extrabold tracking-[-0.04em]">
                Add verified Sukaar banking details before launch.
              </h2>
              <p className="mt-5 text-sm leading-7 text-white/60">
                ...
                branch and donor receipt instructions once confirmed by Sukaar.
              </p>
