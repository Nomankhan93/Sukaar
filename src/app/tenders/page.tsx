...
export const metadata: Metadata = {
  title: "Tenders",
  description: "Current procurement and tender opportunities from Sukaar Welfare Organization.",
};
...
export default async function TendersPage() {
  ...
  return (
    <>
      <SiteHeader />
      <main>
        <PageHero eyebrow="Tenders & procurement" title="Open opportunities. Clear information." description="Current tenders, requests for quotations and procurement notices from Sukaar." />
