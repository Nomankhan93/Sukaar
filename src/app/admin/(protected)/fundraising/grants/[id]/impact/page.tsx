  ...
  return (
    <div>
      <AdminPageHeader
        ...
        title={grant.title}
        description="Reuse published Sukaar project impact data in donor reporting without duplicate manual entry."
      />
      ...
      {!grant.project_id ? (
        <div className="mt-7">
          <Notice tone="error">
            This grant is not linked to a Sukaar project. Link a project on
