...
export const metadata: Metadata = {
  title: "Impact",
  description:
    "Verified project results and impact metrics published by Sukaar Welfare Organization.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Sukaar's public impact metrics are drawn from project-level records that have been reviewed and approved for publication."
        />
        ...
        <section className="section-space bg-white">
          <div className="container-poem">
            <SectionHeading
              ...
              description="Figures only appear here after Sukaar staff mark the underlying project metrics as verified and published."
            />
            ...
            {impact.hasPublishedMetrics ? (
              ...
              <div className="mt-12 rounded-[28px] bg-poem-soft p-10 text-center">
                ...
                <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-poem-muted">
                  Sukaar does not publish placeholder impact figures.
