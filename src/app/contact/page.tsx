...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact Sukaar Welfare Organization (Sukaar) Pakistan.",
};
  ...
  return (
    <>
      ...
      <main>
        <PageHero
          eyebrow="Contact"
          title="Start a conversation with Sukaar."
              ...
              <div className="mt-10 space-y-4">
                ...
                {!details.length ? (
                  <p className="rounded-2xl bg-poem-soft p-5 text-sm text-poem-muted">
                    ...
                    once added by Sukaar administration.
                  </p>
                ) : null}
              </div>
            </div>
              ...
              >
                ...
                <label className="mt-5 block text-sm font-bold text-poem-900">
                  ...
                  <textarea
                    ...
                    maxLength={5000}
                    rows={7}
                    placeholder="How can Sukaar help?"
