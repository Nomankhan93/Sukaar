...
const accents = [
  "from-[#fff7a8] to-[#e8cf58]",
  "from-[#eadcf0] to-[#bfa7ca]",
  "from-[#f2e8c7] to-[#c9b171]",
  "from-[#e9e3ed] to-[#c9bdcf]",
];
...
export async function getPublicProjectBySlug(slug: string) {
  const staticProjectBase = staticProjects.find((project) => project.slug === slug) ?? null;
  const staticProject = staticProjectBase
    ? {
        ...staticProjectBase,
        donorPartner: "",
        coverUrl: null,
